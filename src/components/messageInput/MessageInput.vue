<template>
  <div class="message-input-box">
    <input class="message-input-box__input" type="text" placeholder="Сообщение"
           @change.stop="changeHandler"
           @keyup.enter="sendClickHandler"
    />
    <div class="message-input-box__input-send" @click.stop="sendClickHandler">
...
<style>
  ...
  .message-input-box__input {
    box-sizing: border-box;
    padding: 16px 50px 17px 17px;
    margin: 36px 32px 35px;
    width: 100%;
    background: #FFFFFF;
